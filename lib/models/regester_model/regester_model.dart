...
class RegisterData
{
  ...
  RegisterData.fromjson(Map<String,dynamic>json)
  {
    ...
    shipping_info = json['shipping_info']!= null? UserShippingInfo.fromjson(json['shipping_info']):null;
    package  = json['package'];
    // country  = UserCountry.fromjson(json['user_id']);
    country = json['country']!= null? UserCountry.fromjson(json['country']):null;
